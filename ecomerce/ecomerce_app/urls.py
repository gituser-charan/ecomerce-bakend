...
routers.register('product/about', views.ProductAboutViewSet, "Product About")
...
routers.register('product/tags', views.ProductTagsViewSet, "Product Tags")
routers.register('product/transactions', views.ProductTransactionViewSet, "Product Transactions")
routers.register('product/varients', views.ProductVarientViewSet, "Product Varients")
routers.register('product/varient/items', views.ProductVarientItemsViewSet, "Product Varient Items")
